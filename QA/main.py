...
def main():
    ...
    context_files = [join(CONTEXT_REFINED_DIR, file) for file in listdir(CONTEXT_REFINED_DIR) if isfile(join(CONTEXT_REFINED_DIR, file))]
    ...
    test_data.to_csv('./df_answer.csv')
